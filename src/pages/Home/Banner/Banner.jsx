...
const Banner = () => {
  ...
  <div id="slide1" className="carousel-item relative w-full">
    ...
    <div className="absolute rounded-xl flex items-center h-full flex justify-between transform -translate-y-1/2 left-0 right-5 top-1/2 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
